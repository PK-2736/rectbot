      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-slate-800 rounded-lg p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-slate-400 text-sm">総募集数</p>
        ...
        <div className="bg-slate-800 rounded-lg p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-slate-400 text-sm">アクティブ募集</p>
        ...
        <div className="bg-slate-800 rounded-lg p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-slate-400 text-sm">導入サーバー数</p>
      ...
      <div className="bg-slate-800 rounded-lg p-6">
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-slate-700 rounded-lg">
              <tr>
                <th className="px-4 py-3 text-left font-semibold text-slate-200">ギルド名</th>
                <th className="px-4 py-3 text-left font-semibold text-slate-200">チャンネル</th>
                <th className="px-4 py-3 text-left font-semibold text-slate-200">募集内容</th>
                <th className="px-4 py-3 text-center font-semibold text-slate-200">人数</th>
                <th className="px-4 py-3 text-center font-semibold text-slate-200">開始時間</th>
                <th className="px-4 py-3 text-center font-semibold text-slate-200">ステータス</th>
                <th className="px-4 py-3 text-center font-semibold text-slate-200">作成日時</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-700">
              {recruitments.map((recruitment) => (
                <tr key={`${recruitment.guild_id}-${recruitment.message_id}`} className="hover:bg-slate-800 transition-colors">
                  <td className="px-4 py-3">
                    <div>
                      <p className="font-medium text-white">{recruitment.guild_name}</p>
                      <p className="text-xs text-slate-400">{recruitment.guild_id}</p>
                    </div>
                  </td>
                  <td className="px-4 py-3">
                  ...
                  <td className="px-4 py-3">
                    <div>
                      ...
                      {recruitment.note && (
                        <p className="text-xs text-slate-400 mt-1">{recruitment.note}</p>
                      )}
                    </div>
                  </td>
